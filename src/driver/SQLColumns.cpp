...
//---------------------------------------------------------------------------
CSQLColumns::CSQLColumns (CDatabase * pDatabase
...
//---------------------------------------------------------------------------
bool
CSQLColumns::read (ULONG iRow, CRecord & raRecord) const
{
	...
	raRecord[ 2] = aRecord.table;
	raRecord[ 3] = aRecord.column;
	raRecord[ 4] = aRecord.datatype;
	raRecord[ 5] = aRecord.type_name;
	raRecord[ 6] = aRecord.size;
	raRecord[ 7] = aRecord.length;
	raRecord[ 8] = aRecord.digits;
	raRecord[ 9] = aRecord.num_prec_radix;
	raRecord[10] = aRecord.nullable;
	raRecord[11] = aRecord.remarks;
	raRecord[12] = aRecord.column_def;
	raRecord[13] = aRecord.sql_data_type;
	raRecord[14] = aRecord.sql_datetime_sub;
	raRecord[15] = aRecord.char_octet_length;
	raRecord[16] = aRecord.ordinal_position;
	raRecord[17] = aRecord.is_nullable;
	return true;
}
//---------------------------------------------------------------------------
