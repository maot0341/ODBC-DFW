...
CIPTCCharArray::CIPTCCharArray()
{
	...
	//keywords = 0;
	memset (by_line, 0, sizeof(by_line));
	memset (by_line_title, 0, sizeof(by_line_title));
	memset (copyright, 0, sizeof(copyright));
	memset (credit, 0, sizeof(credit));
	memset (contact, 0, sizeof(contact));
	memset (object_name, 0, sizeof(object_name));
	memset (date_created, 0, sizeof(date_created));
	memset (time_createt, 0, sizeof(time_createt));
	memset (digital_creation_date, 0, sizeof(digital_creation_date));
	memset (digital_creation_time, 0, sizeof(digital_creation_time));
	memset (city, 0, sizeof(city));
	memset (sublocation, 0, sizeof(sublocation));
	*province_state = 0;
	*country_code = 0;
	*country_name = 0;
	*country_name = 0;
