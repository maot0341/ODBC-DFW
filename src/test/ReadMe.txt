========================================================================
       KONSOLENANWENDUNG : test
========================================================================


Diese test-Anwendung hat der Anwendungs-Assistent für Sie erstellt.  

Diese Datei enthält eine Zusammenfassung dessen, was Sie in jeder der Dateien
finden, die Ihre test-Anwendung bilden.
...
StdAfx.h, StdAfx.cpp
    ...
    test.pch und einer vorkompilierten Typdatei namens StdAfx.obj verwendet.
