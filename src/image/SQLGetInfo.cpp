...
//	TRACE ("SQLGetInfo");
	...
	INFOS (SQL_CATALOG_TERM, "direcory");
...
//	INFON (SQL_FILE_USAGE, SQLUSMALLINT, SQL_FILE_TABLE);
...
//	INFON (SQL_ODBC_SQL_CONFORMANCE, SQLUINTEGER, SQL_SC_SQL92_ENTRY);
	...
	INFON (SQL_ACTIVE_STATEMENTS, SQLUSMALLINT, 1);
	INFON (SQL_ACTIVE_CONNECTIONS, SQLUSMALLINT, 2);
